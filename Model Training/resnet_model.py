...
# Compile the model
model = Model(inputs = resnet.input, outputs = base_model)
model.compile(optimizer=Adam(), loss='categorical_crossentropy', metrics=['accuracy'])
model.summary()

#%%
# Define callbacks
checkpoint = ModelCheckpoint('resnet_model.keras', save_best_only=True, monitor='val_accuracy', mode='auto', verbose=1)
